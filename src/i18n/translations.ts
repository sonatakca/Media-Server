...
export const translations = {
  en: {
    "nav.home": "Home",
    "nav.brandHome": "Seyirlik Web home",
    "nav.server": "Server",
    "nav.logout": "Logout",
    ...
    "auth.noPasswordPlaceholder": "Leave blank if this Jellyfin user has no password",
    ...
    "server.couldNotConnect": "Could not connect. Check the URL and Jellyfin network settings.",
    ...
    "settings.auto": "Auto",
    "settings.bestJellyfinSource": "Best Jellyfin source",
    "settings.useBestJellyfinSource": "Use Jellyfin's best source",
  ...
  tr: {
    "nav.home": "Ana Sayfa",
    "nav.brandHome": "Seyirlik Web ana sayfa",
    "nav.server": "Sunucu",
    "nav.logout": "Çıkış",
    ...
    "auth.password": "Şifre",
    "auth.noPasswordPlaceholder": "Bu Jellyfin kullanıcısının şifresi yoksa boş bırak",
    ...
    "server.couldNotConnect": "Bağlanılamadı. Adresi ve Jellyfin ağ ayarlarını kontrol et.",
    "server.localhostNote":
    ...
    "settings.bestJellyfinSource": "En iyi Jellyfin kaynağı",
    "settings.useBestJellyfinSource": "Jellyfin'in en iyi kaynağını kullan",
