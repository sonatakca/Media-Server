export const tr = {
  ...
  "admin.subtitles.authExplanation":
    "Sağlayıcıya biri giriş yapana kadar bu durdu. Seyirlik'in henüz kendi giriş penceresi yok; giriş sağlayıcının kendi sitesinde yapılmalı, ardından deneme kaldığı yerden sürer.",
