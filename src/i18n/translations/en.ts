export const en = {
  ...
  "devtools.card.playbackDiagnostics.title": "Playback diagnostics",
  "devtools.card.playbackDiagnostics.description":
    "Why something will not play: what the server does with each title, and whether this browser can reach it.",
  "devtools.card.playbackDiagnostics.tag": "Diagnostics",
  "library.tag": "Library",
  "library.pageDescription":
    "Every movie, show and book, its state, and everything that can be done to it.",
  "library.books": "Books",
  "library.actionFailed": "That could not be started. Try again.",
  "library.generateTrickplay": "Trickplay",
  "library.trickplay": "Trickplay",
  "library.trickplayCoverage": "files have scrub-bar previews.",
  "library.generateMissing": "Generate missing",
  "library.rebuildAll": "Rebuild all",
  "library.trickplayQueued": "Trickplay queued for",
  "library.trickplayUpToDate": "Every file already has trickplay.",
  "library.trickplayNothing":
    "Nothing is ready for trickplay yet — files still need probing.",
  "library.metadata": "Metadata",
  "library.metadataHint":
    "Refresh from TMDB, or change the match, artwork and titles under Metadata & artwork.",
  "library.refreshMetadata": "Refresh from TMDB",
  "library.metadataQueued": "Metadata refresh queued.",
  "library.noArtwork": "This title has no artwork of its own to edit.",
  "library.processingTitle": "Processing",
  "library.processingHint":
    "Quality ladders are built and watched under Media Processing.",
  "library.titleMissing": "This title is no longer in the library.",
  "library.unwanted": "No longer wanted.",
  "library.nowWanted": "Added to Wanted.",
  "library.tab.overview": "Overview",
  "library.tab.episodes": "Seasons & episodes",
  "library.tab.artwork": "Metadata & artwork",
