export const en = {
  "wanted.addMovie": "Add a movie",
  "wanted.addShow": "Add a show",
  "wanted.unmonitor": "Stop monitoring",
  "wanted.allStatuses": "All statuses",
  "media.statusFilter": "Status",
  "media.status.wanted": "Wanted",
  "media.status.downloading": "Downloading",
  "media.status.downloaded": "Downloaded",
  "media.status.ready": "Ready to play",
  "media.status.missing": "Media missing",
  "media.status.processing": "Processing",
  "media.status.paused": "Paused",
  "media.status.awaiting-import": "Downloaded · awaiting import",

  "notifications.history": "Notification history",
  "notifications.historyEmpty": "No notifications yet.",
  ...
  "tasks.importReconcile": "Checking imports",
  ...
  "tasks.importCheckDetail":
    "Checking pending imports and whether any need attention.",
  "tasks.subtitleDetail":
    "Checking requested subtitle languages and provider attempts.",
  "tasks.examined": "Checked",
  "tasks.changed": "Updated",
  "tasks.retried": "Retries scheduled",
  "tasks.awaitingAlternative": "Need another release",
  "tasks.committed": "Imported",
  "tasks.needsAttention": "Need attention",

  "wanted.catalogue": "Find movies and shows",
  "wanted.description":
    "Browse popular titles or search the TMDB catalogue, including titles outside your library.",
  "wanted.searchLabel": "Search TMDB",
  "wanted.all": "Movies & shows",
  "wanted.movies": "Movie",
  "wanted.shows": "Show",
  "wanted.library": "Library",
  "wanted.saveFailed": "Wanted titles could not be saved or loaded. Try again.",
  "wanted.loadFailed":
    "TMDB could not be loaded. Check Integrations and try again.",
  "wanted.loading": "Loading TMDB…",
  "wanted.saved": "Added to Wanted",
  "wanted.saving": "Adding…",
  "wanted.add": "Add to Wanted",
  "wanted.releases": "Search releases",
  "wanted.noLibrary": "No destination library is configured for this type.",
  "wanted.noResults": "No matching TMDB titles. Try another title.",
  "wanted.previous": "Previous",
  "wanted.next": "Next",
  "wanted.attribution":
    "Metadata provided by TMDB. This product uses the TMDB API but is not endorsed or certified by TMDB.",
  "wanted.list": "Manage library",
  "wanted.intentOnly":
    "Adding a title saves your intent. Choose a release to start a download.",
  "wanted.available": "Media available",
  "wanted.missing": "Not downloaded",

  "admin.subtitles.unconfigured":
    "Automatic subtitle downloads are not configured on this server. There are no active provider attempts to load. Existing subtitles remain available for playback.",
  ...
  "processing.kind.movies": "Films",
  "processing.kind.series": "Shows",
  "processing.tv.emptySeries": "No shows are available.",
  "processing.tv.searchSeries": "Search shows and episodes",
  "processing.tv.noSearchResults": "No shows or episodes match this search.",
  "processing.tv.seasonCount": "{count} seasons",
  "processing.tv.seasonCountOne": "1 season",
  "processing.tv.episodeCount": "{count} episodes",
  "processing.tv.episodeCountOne": "1 episode",
  "processing.tv.season": "Season {number}",
  "processing.tv.specials": "Specials",
  "processing.tv.episode": "Episode",
  "processing.tv.countProcessed": "{count} processed",
  "processing.tv.countPartial": "{count} partly processed",
  "processing.tv.countUnprocessed": "{count} not processed",
  "processing.tv.countActive": "{count} in the queue",
  "processing.tv.countUnavailable": "{count} without a source",
  "processing.tv.processSeries": "Process missing episodes",
  "processing.tv.processSeason": "Process this season",
  "processing.tv.processing": "Queueing…",
  "processing.tv.nothingToDo": "Nothing left to process",
  "processing.tv.bulkQueued": "{count} queued",
  "processing.tv.bulkAlreadyQueued": "{count} already in the queue",
  "processing.tv.bulkAlreadyComplete": "{count} already processed",
  "processing.tv.bulkUnavailable": "{count} without a source",
  "processing.tv.bulkFailed": "{count} could not be queued",
  "processing.tv.episodeComplete": "Processed",
  "processing.tv.episodePartial": "Partly processed",
  "processing.tv.episodeUnprocessed": "Not processed",
  "processing.tv.episodeUnknown": "Checking the package…",
  "processing.tv.episodeUnprobed": "Not analysed yet",
  "processing.tv.expandSeries": "Show seasons of {title}",
  "processing.tv.collapseSeries": "Hide seasons of {title}",
  "processing.tv.expandSeason": "Show episodes of {title}",
  "processing.tv.collapseSeason": "Hide episodes of {title}",
  "processing.tv.alternateSource": "{count} source files · one is processed",
  "processing.subtitle":
  ...
  "processing.counts.paused": "Paused",
  ...
  "processing.queueOrder.sendNext": "Next",
  "processing.queueOrder.sendNextLabel": "Encode {title} next",
  "processing.queueOrder.sendLast": "Last",
  "processing.queueOrder.sendLastLabel": "Move {title} to the end of the queue",
  "processing.queueOrder.groupTitle": "Group by show and episode",
  "processing.queueOrder.groupHint":
    "Keeps each show where it already stands and puts its episodes in order underneath it.",
  "processing.queueOrder.select": "Select {title} for a group move",
  "processing.queueOrder.selectedCount": "{count} selected",
  "processing.queueOrder.selectAll": "Select all waiting",
  "processing.queueOrder.clearSelection": "Clear",
  "processing.queueOrder.groupToTop": "To the front",
  "processing.queueOrder.groupToBottom": "To the end",
  "processing.queueOrder.groupHandle":
    "Move the {count} selected jobs together, from {title}",
  "processing.bulk.resumeAll": "Continue all paused",
  "processing.bulk.resumeAllHint":
    "Lifts every pause an operator set. Jobs waiting on the storage continue on their own.",
  "processing.bulk.pauseAll": "Pause all queued",
  "processing.bulk.pauseAllHint":
    "Holds everything that has not started. The encode that is running is left alone.",
  "processing.bulk.working": "Working…",
  "processing.bulk.failed": "{count} of them could not be changed.",
  ...
  "processing.deleteSource": "Remove source file",
  "processing.deleteSourceConfirm": "Cannot be undone · delete {size}",
  ...
  // Named, not lumped in with "Paused". A quarantine is the storage saying it
  // failed a transfer, and a row that hides that behind the same word an
  // operator's own pause uses is the difference between noticing a dying drive
  // and waiting for a queue that will never move.
  "processing.pausedByQuarantine": "Quarantined",
  "processing.pausedByRecovery": "Needs a check",
  ...
  "processing.phase.planning": "Planning",
  "processing.phase.encoding": "Encoding",
  "processing.phase.audio": "Encoding audio",
  "processing.phase.subtitles": "Converting subtitles",
  "processing.phase.assembling": "Assembling",
  "processing.phase.validating": "Validating",
  "processing.phase.publishing": "Publishing",
  "processing.audio.reused": "Already encoded",
  "processing.audio.trackCount": "Audio tracks ({count}, encoded together)",
  "processing.audio.sharedTimeline": "Source timeline",
  "processing.assembly.waiting": "Waiting",
  "processing.assembly.current": "Current",
  "processing.assembly.writeRate": "Write rate",
  "processing.assembly.remaining": "Remaining",
  "processing.assembly.measuring": "Measuring {rendition}",
  "processing.assembly.rungOf": "rung {index} of {count}",
  "processing.assembly.audioCopy": "Audio copy",
  "processing.assembly.copying": "Copying…",
  "processing.verification.checks": "{done} / {total} checks",
  "processing.verification.videoRenditions": "{count} video renditions",
  "processing.verification.audioTracks": "{count} audio tracks",
  "processing.verification.subtitles": "{count} subtitles",
  "processing.verification.scanRate": "Scan rate",
  "processing.verification.timesRealtime": "{rate}x realtime",
  "processing.verification.waiting": "Waiting for the scan to report…",
  "processing.verification.current": "Checking",
  "processing.verification.weighted":
    "Bar weighted by rendition size; the counts above are exact",
  "processing.verification.kind.metadata": "Package metadata",
  "processing.verification.kind.master-playlist": "Master playlist",
  "processing.verification.kind.video-structure": "Playlist and byte ranges",
  "processing.verification.kind.video-probe": "Media timeline",
  "processing.verification.kind.cross-rendition": "Rendition alignment",
  "processing.verification.kind.audio": "Audio track",
  "processing.verification.kind.subtitle": "Subtitle track",
  "processing.verification.kind.seek-decode": "Seek decoding",
  "processing.verification.kind.cross-quality-splice": "Quality switching",
  "processing.publish.video": "Video renditions",
  "processing.publish.copying": "Copying to media storage",
  "processing.publish.audio": "Audio tracks",
  "processing.publish.subtitles": "Subtitles",
  "processing.publish.master-playlist": "Master playlist",
  "processing.publish.manifest": "Package manifest",
  "processing.publish.build-record": "Build record",
  "processing.publish.swap": "Activating the package",
  "processing.publish.verify": "Verifying destination copy",
  "processing.publish.cleanup": "Clearing checkpoints",
  "processing.phaseHistory": "Completed",
  "processing.phaseStalled": "No progress reported just now",
  "processing.epoch.heading": "Current epoch",
  "processing.epoch.position": "{index} / {count}",
  "processing.epoch.checkpointsSaved": "Checkpoint {done} / {count} saved",
  "processing.epoch.protectedThrough": "Protected through {time}",
  "processing.epoch.protectedMedia": "Protected encoded media",
  "processing.epoch.noneYet": "No checkpoint saved yet",
  "processing.epoch.mediaPosition": "{encoded} / {total}",
  "processing.epoch.videoComplete": "Video encoding complete",
  "processing.sourceIo.waiting": "Waiting for source data…",
  "processing.sourceIo.aborting": "Source read stalled — stopping encoder…",
  "processing.sourceIo.suspected":
    "Source read problem detected (attempt {attempt} of {attempts})",
  "processing.sourceIo.confirmed":
    "The source cannot be read between {from} and {to}",
  "processing.sourceIo.replacing": "Replacing damaged interval {from}–{to}",
  "processing.sourceIo.replaced": "Continuing from {from}",
  "processing.sourceDamage.heading": "Source damage",
  "processing.sourceDamage.badge": "Salvaged",
  "processing.sourceDamage.completed":
    "Processing completed with source damage.",
  "processing.sourceDamage.interval":
    "{from}–{to} was replaced because the source file could not be read.",
  "processing.sourceDamage.audio": "Sound for this interval is silent.",
  "processing.sourceDamage.subtitles":
    "Subtitle cues inside this interval could not be recovered.",
  "processing.sourceDamage.total":
    "{duration} of {count} interval(s) replaced in total.",
  "processing.sourceDamage.advice":
    "The rest of the title encoded normally and is on its original timeline. Replace or repair the source file and process it again to recover this interval.",
  "processing.storage.free": "{free} free",
  "processing.storage.root": "Storage root",
  "processing.storage.faults": "I/O failures",
  "processing.storage.firstFault": "First failure",
  "processing.storage.automaticResume": "Automatic resume",
  "processing.storage.blocked": "Blocked",
  "processing.storage.allowed": "Allowed",
  "processing.storage.lastSafe": "last safe checkpoint {time}",
  "processing.storage.noCheckpoint": "no durable checkpoint yet",
  "processing.storage.adopt": "This is replacement storage — adopt it",
  "processing.storage.adoptFailed": "The storage could not be adopted.",
  "processing.storage.verify": "Storage repaired — verify",
  "processing.storage.resume": "Resume processing",
  "processing.storage.verifyFailed": "The storage could not be verified.",
  "processing.storage.resumeFailed": "Processing could not be resumed.",
  "processing.storage.interrupted": "Storage interrupted",
  ...
  "processing.storage.held.quarantined": "Storage quarantined",
  "processing.storage.held.recoveryPending": "Waiting for an operator check",
  "processing.storage.heldAction":
    "This will not continue on its own, and no button on this row can release it. Verify and resume the storage in the panel at the top of this page.",
  // The disagreement is worth its own sentence. It means the hold lives in the
  // worker's memory and never reached the incident record, so the storage panel
  // shows nothing to resume and there is genuinely nothing to press.
  "processing.storage.heldButHealthy":
    "The storage now reports healthy, but this job is still held. The hold is in the processing worker and was never recorded, so restarting the worker is what releases it.",
  ...
  "processing.pausedLive":
    "The encoder is suspended and holding its place, so Continue resumes it exactly where it stopped. If this machine restarts, at most the current five-minute epoch is encoded again.",
  ...
  "processing.state.pausing": "Pausing…",
  "processing.state.resuming": "Resuming…",
  ...
  "devtools.card.curation.title": "Curation",
  "devtools.card.curation.description":
    "Hand-place the order of the hero carousel, the Latest rows, and the movie and show libraries.",
  "devtools.card.curation.tag": "Shelves",
  ...
  "curation.unavailable": "Curation unavailable",
  "curation.loading": "Loading the library...",
  "curation.loadFailed": "Could not load the library.",
  "curation.eyebrow": "Shelves",
  "curation.title": "Curation",
  "curation.description":
    "Place titles in the order you want them. The order is stored on the server, so every device and every person sees the same shelf.",
  "curation.readOnly":
    "Only an administrator can save an order. You can look, but Save is disabled.",
  "curation.section.carousel": "Hero carousel",
  "curation.section.carouselDescription":
    "The rotating banner at the top of the home page.",
  "curation.section.movies": "Films",
  "curation.section.moviesDescription":
    "One order for the film library and the Latest films row. Seeded newest first.",
  "curation.section.shows": "Shows",
  "curation.section.showsDescription":
    "One order for the show library and the Latest shows row. Seeded newest first.",
  "curation.section.books": "Books",
  "curation.section.booksDescription":
    "One order for the book library and the Latest books row. Seeded newest first.",
  "curation.sectionCount": "{count} titles",
  "curation.searchPlaceholder": "Search title, year, or ID...",
  "curation.searchLabel": "Search titles on this shelf",
  "curation.save": "Save order",
  "curation.saving": "Saving...",
  "curation.saved": "Order saved",
  "curation.saveFailed": "Could not save this order.",
  "curation.upToDate": "No unsaved changes",
  "curation.unsavedChanges": "Unsaved changes",
  "curation.revert": "Revert",
  "curation.clearOrder": "Clear order",
  "curation.stateVisible": "Visible",
  "curation.stateHidden": "Hidden",
  "curation.hiddenBadge": "Hidden",
  "curation.select": "Select {title} for a group move",
  "curation.selectedCount": "{count} selected",
  "curation.selectAllVisible": "Select all shown",
  "curation.clearSelection": "Clear",
  "curation.groupToTop": "To the front",
  "curation.groupToBottom": "To the end",
  "curation.groupHide": "Hide from home",
  "curation.handle": "Drag {title}, now at {position}",
  "curation.groupHandle":
    "Drag the {count} selected titles, starting with {title}",
  "curation.handleHint": "Drag to reorder, or use the arrow keys",
  "curation.hideHint":
    "Keeps the title off the home page. It stays in its library.",
  "curation.moveTopItem": "Move {title} to top",
  "curation.moveUpItem": "Move {title} up",
  "curation.moveDownItem": "Move {title} down",
  ...
  "notifications.waiting": "+{count} waiting",
  "tasks.mediaProcess": "Media processing",
  "tasks.nfoItem": "Item NFO export",
  "tasks.nfoLibrary": "Library NFO export",
  "tasks.queued": "Queued",
  "tasks.running": "Running",
  "tasks.retrying": "Waiting to retry",
  "tasks.succeeded": "Completed",
  "tasks.failed": "Failed",
  "tasks.cancelled": "Cancelled",
  "tasks.waiting-for-storage": "Waiting for storage",
  "tasks.paused": "Paused",
  "tasks.reading": "Reading library folders",
  "tasks.catalogue": "Updating catalogue",
  "tasks.analysing": "Analysing media files",
  "tasks.identifying": "Identifying titles",
  "tasks.nfo": "Writing NFO metadata",
  "tasks.starting": "Starting media processing",
  "tasks.indeterminate": "Progress not measurable yet",
  "tasks.deleted": "Deleted item",
  "tasks.safeFailure":
    "The task could not finish. Check its settings and service availability before retrying.",
  "tasks.attempt": "Attempt {count} of {total}",
  "tasks.elapsed": "Running for {duration}",
  "tasks.remaining": "About {duration} left",
  "tasks.unnamed": "Unnamed title",
  "tasks.duration": "Completed in {duration}",
  "tasks.timeSpent": "Elapsed: {duration}",
  "tasks.files": "{count} of {total} files inspected",
  "tasks.titles": "{count} of {total} titles processed",
  "tasks.items": "{count} of {total} items processed",
  "tasks.roots": "{count} of {total} folders walked",
  "tasks.libraries": "{count} of {total} libraries covered",
  "tasks.moves": "{count} of {total} moves applied",
  "tasks.renames": "{count} of {total} renames applied",
  "tasks.directories": "{count} of {total} directories walked",
  "tasks.frames": "{count} of {total} frames sampled",
  "tasks.matched": "Titles matched",
  "tasks.ambiguous": "Titles needing review",
  "tasks.notFound": "Titles not found",
  "tasks.probed": "Files inspected",
  "tasks.spriteCount": "Trickplay sheets generated",
  "tasks.itemsCreated": "Items added",
  "tasks.itemsUpdated": "Items updated",
  "tasks.itemsMarkedMissing": "Items marked missing",
  "tasks.itemsDeleted": "Items removed",
  "tasks.filesCreated": "Files added",
  "tasks.filesChanged": "Files changed",
  "tasks.filesMarkedMissing": "Files marked missing",
  "tasks.filesDeleted": "Files removed",
  "tasks.probesQueued": "Inspections queued",
  "tasks.created": "NFO files created",
  "tasks.updated": "NFO files updated",
  "tasks.unchanged": "NFO files unchanged",
  "tasks.skippedConflict": "Conflicts skipped",
  "tasks.skippedNotApplicable": "Inapplicable files skipped",
  "tasks.itemsConsidered": "Items considered",
  "tasks.not-found": "No metadata match found",
  "tasks.skipped": "Metadata refresh skipped",
  "tasks.not-generated": "No trickplay generated",
  "tasks.removals-suppressed":
    "Removal protection kept missing items in the catalogue",
  "tasks.trickplay": "Generating trickplay",
  "tasks.selecting": "Scanning for missing trickplay",
  "tasks.planning": "Planning media processing",
  "tasks.video": "Encoding video",
  "tasks.audio": "Encoding audio",
  "tasks.subtitles": "Processing subtitles",
  "tasks.packaging": "Packaging media",
  "tasks.validating": "Verifying output",
  "tasks.publishing": "Publishing media",
  "tasks.damaged-output":
    "Completed with repaired gaps in damaged source media. Review the processing details.",
  "tasks.error.deleted":
    "The subject was deleted. Select an existing item before retrying.",
  "tasks.error.provider":
    "No metadata provider is configured. Configure a provider before retrying.",
  "tasks.error.hdr-unsupported":
    "This title is HDR. Trickplay for HDR needs an FFmpeg built with the zscale filter (libzimg); SDR titles are unaffected.",
  "tasks.error.unavailable":
    "This service is unavailable. Check the server configuration before retrying.",
  "tasks.encodedClock": "{count} / {total}",
  "tasks.libraryScan": "Library scan",
  "tasks.libraryOrganize": "Folder organisation",
  "tasks.libraryRename": "File naming",
  "tasks.libraryMaintenance": "Library maintenance",
  "tasks.trickplayScan": "Trickplay sweep",
  "tasks.organizing": "Organising folders",
  "tasks.moving": "Moving files",
  "tasks.enqueueing": "Scheduling work",
  "tasks.waiting": "Waiting for queued work",
  "tasks.naming": "Naming files",
  "tasks.maintenance": "Running maintenance",
  "tasks.planned": "Changes planned",
  "tasks.moved": "Files moved",
  "tasks.movesSkipped": "Moves skipped",
  "tasks.movesFailed": "Moves failed",
  "tasks.renamed": "Files renamed",
  "tasks.renamesSkipped": "Renames skipped",
  "tasks.renamesFailed": "Renames failed",
  "tasks.trickplayQueued": "Trickplay jobs queued",
  "tasks.trickplayPending": "Titles still waiting",
  "tasks.organize-disabled":
    "File organisation is switched off in the server configuration. Nothing was changed on disk.",
  "tasks.plan-only":
    "Planning only: the changes were worked out and reported, and nothing was moved or renamed.",
  "tasks.deferred-processing":
    "Deferred while media processing is using these files. Run it again once the queue is clear.",
  "tasks.incomplete":
    "Stopped before finishing. The remaining work is still queued and will continue.",
  ...
  "maintenance.actionsLabel": "Library maintenance actions",
  "maintenance.allInOne": "All in one",
  "maintenance.allInOneHint":
    "Scan every library, then name and file its media, then build trickplay.",
  "maintenance.scanMovies": "Scan movies",
  "maintenance.scanShows": "Scan shows",
  "maintenance.scanBooks": "Scan books",
  "maintenance.generateTrickplays": "Generate trickplay",
  "maintenance.renameFiles": "Rename files",
  "maintenance.moveFiles": "Move files to correct places",
  "maintenance.actionQueued": "Queued. Progress appears in background tasks.",
  "maintenance.actionQueuedCount":
    "Queued for {count} libraries. Progress appears in background tasks.",
  "maintenance.actionNoLibraries":
    "No libraries of this kind are configured, so there was nothing to queue.",
  "maintenance.actionStarting": "Queueing...",
  "maintenance.actionFailed": "Could not queue this maintenance action.",
  "maintenance.tasks.refresh": "Refresh",
  "maintenance.tabs.label": "Library maintenance sections",
  "maintenance.tab.scan": "Library Scan",
  "maintenance.tab.metadata": "Metadata Edit",
  "maintenance.tab.scanHint":
    "Run maintenance and watch what the server is doing.",
  "maintenance.tab.metadataHint":
    "Search the catalogue and edit a title's metadata and artwork.",
  "maintenance.tasks.title": "Tasks",
  "maintenance.tasks.label": "Maintenance task status",
  "maintenance.tasks.active": "In progress",
  "maintenance.tasks.concluded": "Concluded",
  "maintenance.tasks.activeCount": "In progress ({count})",
  "maintenance.tasks.concludedCount": "Concluded ({count})",
  "maintenance.tasks.pagerLabel": "Task pages",
  "maintenance.tasks.pageRange": "Showing {from}-{to} of {total}",
  "maintenance.tasks.pageOf": "Page {page} of {pages}",
  "maintenance.tasks.previousPage": "Previous",
  "maintenance.tasks.nextPage": "Next",
  "maintenance.tasks.loading": "Reading the task list...",
  "maintenance.tasks.failed":
    "The task list could not be read. Showing the last snapshot.",
  "maintenance.tasks.emptyActive": "Nothing is running.",
  "maintenance.tasks.emptyActiveHint":
    "Queued and running maintenance work appears here as soon as it is accepted.",
  "maintenance.tasks.emptyConcluded": "No maintenance has finished yet.",
  "maintenance.tasks.emptyConcludedHint":
    "Completed, failed and cancelled work is kept here by the server.",
  "maintenance.tasks.refreshedAt": "Updated {time}",
  "maintenance.tasks.details": "Details",
  "maintenance.tasks.hideDetails": "Hide details",
  "maintenance.tasks.cancel": "Cancel",
  "maintenance.tasks.cancelling": "Cancelling...",
  "maintenance.tasks.cancelFailed": "This task could not be cancelled.",
  "maintenance.tasks.expand": "Show details for {title}",
  "maintenance.tasks.collapse": "Hide details for {title}",
  "maintenance.operation.library.scan": "Scan library",
  "maintenance.operation.library.organize": "Move files",
  "maintenance.operation.library.rename": "Rename files",
  "maintenance.operation.library.maintenance": "All in one",
  "maintenance.operation.media.probe": "Analyse media",
  "maintenance.operation.metadata.scan": "Match metadata",
  "maintenance.operation.metadata.refresh": "Refresh metadata",
  "maintenance.operation.trickplay.generate": "Generate trickplay",
  "maintenance.operation.trickplay.scan": "Scan for missing trickplay",
  "maintenance.operation.unknown": "Maintenance task",
  "maintenance.lifecycle.queued": "Waiting",
  "maintenance.lifecycle.scheduled": "Scheduled",
  "maintenance.lifecycle.retry-waiting": "Retrying",
  "maintenance.lifecycle.running": "Running",
  "maintenance.lifecycle.succeeded": "Completed",
  "maintenance.lifecycle.failed": "Failed",
  "maintenance.lifecycle.cancelled": "Cancelled",
  "maintenance.phase.reading": "Reading the library folders",
  "maintenance.phase.catalogue": "Reconciling the catalogue",
  "maintenance.phase.analysing": "Analysing media files",
  "maintenance.phase.identifying": "Identifying titles",
  "maintenance.phase.nfo": "Writing NFO sidecars",
  "maintenance.phase.planning": "Working out the plan",
  "maintenance.phase.moving": "Moving files",
  "maintenance.phase.naming": "Renaming files",
  "maintenance.phase.selecting": "Choosing titles",
  "maintenance.phase.enqueueing": "Scheduling work",
  "maintenance.phase.trickplay": "Generating trickplay",
  "maintenance.phase.waiting": "Waiting for queued work",
  "maintenance.unit.files": "files",
  "maintenance.unit.titles": "titles",
  "maintenance.unit.items": "items",
  "maintenance.unit.roots": "folders",
  "maintenance.unit.libraries": "libraries",
  "maintenance.unit.moves": "moves",
  "maintenance.unit.renames": "renames",
  "maintenance.unit.directories": "directories",
  "maintenance.unit.frames": "frames",
  "maintenance.measure.exact": "{completed} / {total} {unit}",
  "maintenance.measure.exactProvisional":
    "{completed} of {total} {unit} so far",
  "maintenance.measure.counter": "{count} {unit}",
  "maintenance.measure.phase": "Phase {index} of {count}",
  "maintenance.measure.unknown": "No measurable progress yet",
  "maintenance.measure.provisionalHint":
    "The total is still moving as more work is discovered.",
  "maintenance.measure.unknownHint":
    "This stage has no total to measure against, so no percentage is shown.",
  "maintenance.scope.allLibraries": "All libraries",
  "maintenance.scope.allLibrariesCount": "All libraries ({count})",
  "maintenance.scope.libraryDeleted": "Deleted library",
  "maintenance.scope.itemDeleted": "Deleted item",
  "maintenance.scope.unnamed": "Unnamed",
  "maintenance.timing.queuedAt": "Queued",
  "maintenance.timing.startedAt": "Started",
  "maintenance.timing.finishedAt": "Finished",
  "maintenance.timing.lastUpdate": "Last update",
  "maintenance.timing.queueWait": "Queue wait",
  "maintenance.timing.elapsed": "Elapsed",
  "maintenance.timing.elapsedValue": "{value} elapsed",
  "maintenance.timing.silentFor": "No update for {value}",
  "maintenance.timing.retryAt": "Next attempt {time}",
  "maintenance.detail.identity": "Identity",
  "maintenance.detail.timing": "Timing",
  "maintenance.detail.execution": "Current execution",
  "maintenance.detail.counters": "Counters",
  "maintenance.detail.results": "Results",
  "maintenance.detail.problems": "Problems",
  "maintenance.detail.taskId": "Task ID",
  "maintenance.detail.runId": "Run ID",
  "maintenance.detail.operation": "Operation",
  "maintenance.detail.scope": "Scope",
  "maintenance.detail.attempt": "Attempt",
  "maintenance.detail.attemptValue": "{attempt} of {max}",
  "maintenance.detail.queuePosition": "Queue position",
  "maintenance.detail.currentItem": "Current item",
  "maintenance.detail.runMembers": "Part of a run with {count} tasks",
  "maintenance.detail.failureList": "Items that could not be done",
  "maintenance.detail.failuresTruncated": "Only the first {count} are kept.",
  "maintenance.detail.noFailures": "Nothing failed.",
  "maintenance.counter.filesDiscovered": "Files discovered",
  "maintenance.counter.filesSkipped": "Files skipped",
  "maintenance.counter.itemsCreated": "Titles added",
  "maintenance.counter.itemsUpdated": "Titles updated",
  "maintenance.counter.itemsMarkedMissing": "Titles marked missing",
  "maintenance.counter.itemsDeleted": "Titles removed",
  "maintenance.counter.filesCreated": "Files added",
  "maintenance.counter.filesChanged": "Files changed",
  "maintenance.counter.filesMarkedMissing": "Files marked missing",
  "maintenance.counter.filesDeleted": "Files removed",
  "maintenance.counter.probesQueued": "Analyses queued",
  "maintenance.counter.probed": "Files analysed",
  "maintenance.counter.probeFailed": "Analyses failed",
  "maintenance.counter.matched": "Titles matched",
  "maintenance.counter.ambiguous": "Need review",
  "maintenance.counter.notFound": "Not found",
  "maintenance.counter.nfoCreated": "NFO files written",
  "maintenance.counter.nfoUpdated": "NFO files updated",
  "maintenance.counter.nfoUnchanged": "NFO files unchanged",
  "maintenance.counter.nfoSkippedConflict": "NFO files skipped (conflict)",
  "maintenance.counter.nfoSkippedNotApplicable": "NFO files not applicable",
  "maintenance.counter.nfoFailed": "NFO files failed",
  "maintenance.counter.planned": "Moves planned",
  "maintenance.counter.moved": "Files moved",
  "maintenance.counter.movesSkipped": "Moves skipped",
  "maintenance.counter.movesFailed": "Moves failed",
  "maintenance.counter.renamed": "Files renamed",
  "maintenance.counter.renamesSkipped": "Renames skipped",
  "maintenance.counter.renamesFailed": "Renames failed",
  "maintenance.counter.trickplayQueued": "Trickplay jobs queued",
  "maintenance.counter.trickplayPending": "Titles still without trickplay",
  "maintenance.counter.spriteCount": "Trickplay sheets written",
  "maintenance.outcome.completed-with-failures": "Completed with failures",
  "maintenance.outcome.cancelled": "Stopped on request",
  "maintenance.outcome.plan-only": "Planned only",
  "maintenance.outcome.organize-disabled":
    "File organisation is disabled; nothing was moved or renamed",
  "maintenance.outcome.deferred-processing":
    "Deferred while media was processing",
  "maintenance.outcome.incomplete": "Stopped before finishing",
  "maintenance.outcome.removals-suppressed": "Removals suppressed",
  "maintenance.outcome.nothing-to-do": "Nothing to do",
  "maintenance.error.library-deleted": "The library no longer exists.",
  "maintenance.error.item-deleted": "The title no longer exists.",
  "maintenance.error.provider-missing": "No metadata provider is configured.",
  "maintenance.error.unavailable":
    "This operation is not available on this server.",
  "maintenance.error.hdr-unsupported":
    "Trickplay for HDR needs an FFmpeg built with the zscale filter.",
  "maintenance.error.payload-invalid":
    "The task was queued without everything it needed.",
  "maintenance.error.lease-expired":
    "The task did not finish before its lease expired.",
  "maintenance.error.unknown": "The task failed.",
  "maintenance.reason.source-missing": "Source missing",
  "maintenance.reason.permission-denied": "Permission denied",
  "maintenance.reason.destination-exists": "Destination already exists",
  "maintenance.reason.provider-failed": "Metadata provider failed",
  "maintenance.reason.unsupported": "Not supported",
  "maintenance.reason.filesystem-error": "Filesystem error",
  "maintenance.reason.database-error": "Database error",
  "maintenance.reason.unknown": "Unknown reason",
  "maintenance.queueOrder.title": "Queue order",
  "maintenance.queueOrder.hint": "Drag to reorder, or use the arrow keys.",
  "maintenance.queueOrder.handle":
    "Move {title}, position {position} of {total}",
  "maintenance.queueOrder.groupHandle":
    "Move {count} selected tasks, held by {title}",
  "maintenance.queueOrder.select": "Select {title}",
  "maintenance.queueOrder.selectedCount": "{count} selected",
  "maintenance.queueOrder.selectAll": "Select all waiting",
  "maintenance.queueOrder.clear": "Clear selection",
  "maintenance.queueOrder.front": "Send to front",
  "maintenance.queueOrder.back": "Send to back",
  "maintenance.queueOrder.failed": "The queue order was not accepted.",
  ...
  "admin.health.tag": "Operations",
  "admin.health.refresh": "Check again",
  "admin.health.checking": "Checking…",
  "admin.health.checkedAt": "Checked at",
  "admin.health.needsOperator": "This one needs you. Playback is affected.",
  "admin.health.waiting": "Waiting for you",
  "admin.health.notAnswered": "Did not answer",
  "admin.health.verdict.serving": "Serving",
  "admin.health.verdict.degraded": "Serving, with something not working",
  "admin.health.verdict.starting": "Starting up",
  "admin.health.verdict.not-serving": "Not serving",
  "admin.health.verdict.unreachable": "No answer from the server",
  "admin.health.tier.core": "Seyirlik itself",
  "admin.health.tier.capability": "What it can do",
  "admin.health.tier.dependency": "Things it talks to",
  "admin.health.tierDescription.core":
    "If one of these is down, the server cannot serve.",
  "admin.health.tierDescription.capability":
    "These limit what it can do, without stopping what it already has.",
  "admin.health.tierDescription.dependency":
    "Other programs. One being off does not make Seyirlik unwell.",
  "admin.health.state.ok": "Working",
  "admin.health.state.degraded": "Degraded",
  "admin.health.state.down": "Down",
  "admin.health.state.off": "Not configured",
  "admin.health.state.unknown": "Unknown",
  "admin.health.signal.server": "Server",
  "admin.health.signal.database": "Database",
  "admin.health.signal.jobs": "Worker",
  "admin.health.signal.ffmpeg": "FFmpeg",
  "admin.health.signal.ffprobe": "FFprobe",
  "admin.health.signal.mediaStorage": "Media storage",
  "admin.health.signal.generatedStorage": "Generated storage",
  "admin.health.signal.downloadClient": "Download client",
  "admin.health.signal.importsNeedingAttention": "Imports needing a decision",
  ...
  "admin.decisions.tag": "Operations",
  "admin.decisions.titleField": "Title",
  "admin.decisions.yearField": "Year",
  "admin.decisions.profileField": "Quality profile",
  "admin.decisions.kindField": "Kind",
  "admin.decisions.kind.movie": "Film",
  "admin.decisions.kind.tv": "Series",
  "admin.decisions.search": "Search",
  "admin.decisions.counts": "Allowed by this profile",
  "admin.decisions.noResults": "No releases were found for that title.",
  "admin.decisions.searchFailed": "The search could not be completed.",
  "admin.decisions.profilesFailed": "The quality profiles could not be loaded.",
  "admin.decisions.recommended": "Recommended",
  "admin.decisions.accepted": "Allowed",
  "admin.decisions.rejected": "Rejected",
  ...
  "admin.imports.description":
    "What the importer has moved into the library, and what is waiting on a decision.",
  "admin.imports.tag": "Operations",
  "admin.imports.refresh": "Refresh",
  "admin.imports.empty": "Nothing has been imported yet.",
  "admin.imports.loadFailed": "The imports could not be loaded.",
  "admin.imports.gate.title": "Storage is not authorised for changes",
  "admin.imports.gate.notConfigured":
    "No import root is configured, so nothing can be written to the library. The expansion drive is still waiting to be backed up and imaged before Seyirlik writes to it.",
  "admin.imports.gate.recorded": "Recorded",
  "admin.imports.gate.recordedOn": "recorded on",
  "admin.imports.gate.hardlinksYes": "hardlinks supported",
  "admin.imports.gate.hardlinksNo": "no hardlinks",
  "admin.imports.gate.wouldUse": "would use",
  "admin.imports.strategy.hardlink": "Hardlink",
  "admin.imports.strategy.copy": "Copy",
  "admin.imports.strategy.move": "Move",
  "admin.imports.strategyUnknown": "Operation not chosen yet",
  "admin.imports.upgrade": "upgrade",
  "admin.imports.attempt": "attempt",
  "admin.imports.retry": "Try again",
  "admin.imports.reconcile": "Check what happened",
  "admin.imports.state.planned": "Planned",
  "admin.imports.state.validating": "Reading the download",
  "admin.imports.state.staging": "Staging",
  "admin.imports.state.committing": "Publishing",
  "admin.imports.state.committed": "Published",
  "admin.imports.state.cleaning": "Tidying up",
  "admin.imports.state.complete": "Complete",
  "admin.imports.state.failed": "Failed",
